...
#ifndef Swing_HalfFloat_H
#define Swing_HalfFloat_H
...
typedef unsigned short SEHalfFloat;

SE_CORE_API SEHalfFloat ToHalf(float fValue);
SE_CORE_API float ToFloat(SEHalfFloat hfValue);
